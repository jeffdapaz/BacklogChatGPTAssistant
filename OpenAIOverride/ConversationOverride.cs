...
{
    /// <summary>
    /// To override the 'Conversation' class from the OpenAI library.
    /// Fix some original bugs and added some updates
    /// </summary>
    public class ConversationOverride : Conversation
    {
        ...
        public new ChatRequestOverride RequestParameters { get; private set; }
        ...
        public ConversationOverride(ChatEndpoint endpoint, Model model = null, ChatRequestOverride defaultChatRequestArgs = null) : base(endpoint, model, defaultChatRequestArgs)
        {
            this.endpoint = endpoint;

            RequestParameters = new ChatRequestOverride(defaultChatRequestArgs);
        }
        ...
        public new async Task<string> GetResponseFromChatbotAsync()
        {
            try
            {
                ChatRequestOverride req = new(RequestParameters) { Messages = Messages.ToList() };
